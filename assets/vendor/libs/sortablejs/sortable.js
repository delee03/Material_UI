                                ...
                                getEventProperties: function (t, e) {
                                    ...
                                    return (
                                        W.forEach(function (o) {
                                            "function" ==
                                                typeof o.eventProperties &&
                                                i(
                                                    n,
                                                    o.eventProperties.call(
                                                        e[o.pluginName],
                                                        t
                                                    )
                                                );
                                    ...
                                    return (
                                        W.forEach(function (i) {
                                            t[i.pluginName] &&
                                                i.optionListeners &&
                                                "function" ==
                                                    typeof i.optionListeners[
                                                        e
                                                    ] &&
                                                (o = i.optionListeners[e].call(
                                                    t[i.pluginName],
                                                    n
                                                ));
                                        }),
                            ...
                            Rt = function (t, e) {
                                ...
                                if ("flex" === n.display)
                                    return "column" === n.flexDirection ||
                                        ...
                                        : "horizontal";
                                if ("grid" === n.display)
                                    return n.gridTemplateColumns.split(" ")
                                        .length <= 1
                                        ? "vertical"
                                        : "horizontal";
                                if (i && a.float && "none" !== a.float) {
                                    var u =
                                        "left" === a.float ? "left" : "right";
                                    return !r ||
                                        ("both" !== l.clear && l.clear !== u)
                                        ? "horizontal"
                                        : "vertical";
                                }
                                return i &&
                        ...
                        (Ht.prototype = {
                            ...
                            _emulateDragOver: function () {
                                if (ht) {
                                    ...
                                    for (
                                        ...
                                        e = t;
                                    if (
                                        ($.parentNode[L]._isOutsideThisEl(t), e)
                                    )
                                        do {
                                            if (
                                                e[L] &&
                            ...
                            _onTouchMove: function (t) {
                                if (dt) {
                                    var e = this.options,
                                        ...
                                        s = Nt && Et && P(Et),
                                        c =
                                            (i.clientX - dt.clientX + o.x) /
                                                (a || 1) +
                                            (s ? s[0] - Tt[0] : 0) / (a || 1),
                                        u =
                                            (i.clientY - dt.clientY + o.y) /
                                                (l || 1) +
                                            (s ? s[1] - Tt[1] : 0) / (l || 1);
                                    if (!Ht.active && !Dt) {
                                        if (
                                            ...
                                            Math.max(
                                                Math.abs(
                                                    i.clientX - this._lastX
                                                ),
                                                Math.abs(
                                                    i.clientY - this._lastY
                                                )
                                            ) < n
                                        )
                                            return;
                                ...
                                if (!J) {
                                    ...
                                    S((J = $.cloneNode(!0)), n.ghostClass, !1),
                                        ...
                                        _(
                                            J,
                                            "transform-origin",
                                            (gt / parseInt(J.style.width)) *
                                                100 +
                                                "% " +
                                                (vt /
                                                    parseInt(J.style.height)) *
                                                    100 +
                                                "%"
                                        );
                                }
                            ...
                            sort: function (t, e) {
                                ...
                                this.toArray().forEach(function (t, e) {
                                    var i = o.children[e];
                                    w(i, this.options.draggable, o, !1) &&
                                        (n[t] = i);
                                }, this),
                            ...
                            _hideClone: function () {
                                if (!it) {
                                    if (
                                        (V("hideClone", this), Ht.eventCanceled)
                                    )
                                        return;
                                    _(ot, "display", "none"),
                                        ...
                                        (t.prototype = {
                                            ...
                                            dragStartGlobal: function (t) {
                                                t.sortable,
                                                    !this.isMultiDrag &&
                                                        de &&
                                                        de.multiDrag._deselectMultiDrag(),
                                                    ge.forEach(function (t) {
                                                        t.sortableIndex = I(t);
                                                    }),
                                                    (ge = ge.sort(function (
