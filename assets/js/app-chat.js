...
document.addEventListener("DOMContentLoaded", function () {
    {
        const o = document.querySelector(".app-chat-contacts .sidebar-body"),
            ...
            d = document.querySelector(".app-chat-sidebar-left .sidebar-body"),
            u = document.querySelector(".app-chat-sidebar-right .sidebar-body"),
            h = [].slice.call(
                document.querySelectorAll(
                ...
                e.addEventListener("click", (e) => {
                    var t = document.querySelector(
                        ...
                        t =
                            ...
                            Helpers._addClass(
                                "avatar avatar-xl chat-sidebar-avatar " + y[e],
                                t
                            ),
